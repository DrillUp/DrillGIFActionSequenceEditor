#ifndef P_MRe_Controller_H
#define P_MRe_Controller_H
#include "stdafx.h"
...
-----==========================================================-----
*/
class P_MRe_Controller : public QObject
{
	Q_OBJECT

	public:
		P_MRe_Controller();				//构造函数
		~P_MRe_Controller();				//析构函数
