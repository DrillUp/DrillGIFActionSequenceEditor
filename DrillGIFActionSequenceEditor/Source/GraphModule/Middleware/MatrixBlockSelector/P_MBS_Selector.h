#ifndef P_MBS_Controller_H
#define P_MBS_Controller_H
#include "stdafx.h"
...
-----==========================================================-----
*/
class P_MBS_Selector : public QObject
{
	Q_OBJECT
	...
	private:
		...
		QList<I_MBS_Block*> m_blockTank;		//方块容器
	public:
										//方块 - 获取全部方块
		QList<I_MBS_Block*> getAllBlock();
										//方块 - 获取方块矩阵（单位图块）
	...
	signals:
										//方块 - 新方块被添加（信号）
		void newBlockAdded(I_MBS_Block* new_block,QGraphicsSvgItem* svgItem);
										//方块 - 全部方块被清除前（信号）
		void oldBlockClearBefore(QList<I_MBS_Block*> block_list, QList<QGraphicsSvgItem*> svgItem_list);
	private:
										//方块 - 添加方块（私有）
