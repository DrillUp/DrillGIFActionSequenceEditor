...
-----==========================================================-----
*/
class C_StateTreeNodeFactory;
CLASS_PTR(C_StateTreeNode);
class C_StateTreeNode : public C_TreeNode{

	public:
							//【此类需要通过工厂来创建】
		C_StateTreeNode(QString id, QString factory_id, QString nodeName);	//构造函数
		~C_StateTreeNode();													//析构函数
