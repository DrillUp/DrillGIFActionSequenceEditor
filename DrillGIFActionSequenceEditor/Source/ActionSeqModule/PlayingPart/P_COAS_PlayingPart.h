#ifndef P_COAS_PlayingPart_H
#define P_COAS_PlayingPart_H

#include <QtWidgets>
#include "ui_P_COAS_PlayingPart.h"
...
class P_COAS_PlayingPart : public QWidget
{
	...
	public:
		P_COAS_PlayingPart(P_COAS_StatePart* state_part, P_COAS_StateNodePart* stateNode_part, P_COAS_ActionPart* action_part, QWidget *parent = 0);
		~P_COAS_PlayingPart();
		
	//-----------------------------------
	//----控件
	public:
		P_COAS_StatePart* m_statePart;
		P_COAS_StateNodePart* m_stateNodePart;
		P_COAS_ActionPart* m_actionPart;
	...
	private:
		Ui::P_COAS_PlayingPart ui;

};

#endif // P_COAS_PlayingPart_H
